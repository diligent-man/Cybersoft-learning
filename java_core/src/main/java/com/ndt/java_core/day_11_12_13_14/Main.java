...
public class Main {
    ...
    public static void playWithPolymorphism() {
        ...
        NhanVien giamDoc = new GiamDoc("Giam Doc A", "Nam", "Nguyen Van B");
        giamDoc.xuatThongTin();
        ...
        nhanViens.add(giamDoc);
        nhanViens.add(chuTich);
        ...
        TinhNang tinhNangGiamDoc = (GiamDoc) nhanViens.get(0);
        tinhNangGiamDoc.tinhLuong();
    ...
    static void main() {
        ...
        /*
            4 tính chất của hướng đối tượng:
                ...
                2/ Tính đóng gói
                    class vs package access scope
                3/ Tính trừu tượng
                    abstract class: giống class 100% nhưng không sử dụng được, chỉ dùng để kế thừa
                    interface: dùng định nghĩa hàm
                        biến trong interface là hằng
                4/ Tính đa hình
                    Từ lớp cha có thể khởi tạo ra lớp con
