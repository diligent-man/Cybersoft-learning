...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                <div class="col-xs-12">
                                    <h3 class="counter text-right m-t-15 <c:out value='${projectTaskStatusStats.taskColorMap[status]}'/>">${projectTaskStatusStats.taskStatusRateMap[status]}%</h3>
                                </div>
                                <div class="col-xs-12">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                             ...
                                             style="width: ${projectTaskStatusStats.taskStatusRateMap[status]}%"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <c:forEach items="${projectTaskStatusStats.userTaskStatusStatsList}" var="userTaskStatusStats">
                <div class="row">
                    <div class="col-xs-12">
                        <a href="#" class="group-title">
                            <img width="30" src="plugins/images/users/pawandeep.jpg" class="img-circle"/>
                            <span>${userTaskStatusStats.fullName}</span>
                        </a>
                    </div>
                    ...
                    <c:forEach items="${statusLst}" var="status">
                        <div class="col-md-4">
                            <div class="white-box">
                                <h3 class="box-title">${status} (${userTaskStatusStats.taskStatusRateMap[status]}%)</h3>
                                <c:forEach items="${userTaskStatusStats.taskStatusDetailMap[status]}" var="task">
                                    <div class="message-center">
                                        <a href="#">
                                            <div class="mail-contnet">
                                                <h5>${task.taskName}</h5>
                                                <span class="mail-desc">${task.submitMessage}</span>
                                                <span class="time">${task.formattedSubmitTime}</span>
                                            </div>
                                        </a>
                                    </div>
                                </c:forEach>
