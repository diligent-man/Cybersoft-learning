...
-- 6 tasks
INSERT INTO tasks(name, start_date, end_date, submit_message, submit_time, user_id, project_id, status_id)
VALUES ('Code Backend', '2026-05-02', '2026-05-20', 'Đã tét', '2026-05-19 00:00:00',  1, 1, 3),
       ('Code Frontend', '2026-05-21', '2026-06-20', 'Đã test', '2026-06-19 00:00:00',  1, 1, 2),
       ('Deploy Website', '2026-05-20', '2026-05-28', 'Test đã', '2026-05-27 00:00:00',  1, 3, 1),
       ('Test API', '2026-05-10', '2026-05-15', 'Finally it done', '2026-05-14 00:00:00',  2, 1, 3),
       ('Integration test', '2026-05-16', '2026-05-20', 'So hard', '2026-05-19 00:00:00',  2, 1, 3),
       ('A/B API', '2026-05-16', '2026-05-17', 'Amazing task', '2026-05-16 00:00:00',  2, 1, 2),
       ('Intergation Test', '2026-05-18', '2026-05-19', 'Difficult task', '2026-05-18 00:00:00',  2, 1, 1),
       ('Compatability Test ', '2026-05-18', '2026-05-19', 'Very hard', '2026-05-18 00:00:00',  2, 1, 1),
       ('Thiết kế giao diện', '2026-05-01', '2026-05-05', 'Preview please', '2026-05-04 00:00:00',  3, 1, 2),
       ('Làm Login Mobile', '2026-05-11', '2026-05-25', 'Help me out !', '2026-05-24 00:00:00',  4, 2, 2);
